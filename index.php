...
$info =$bdd->query('SELECT * FROM plat_du_jour');
$tea =$bdd->query('SELECT * FROM team');
$img =$bdd->query('SELECT * FROM gallery');
$me =$bdd->query('SELECT * FROM menu');
$categ =$bdd->query('SELECT * FROM categorie_menu');
?>
...
<!-- Mirrored from technext.github.io/food-funday/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Oct 2022 17:08:45 GMT -->
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="special-box">
                        <div id="owl-demo">
                        <?php foreach ($info as $special){?>
                            <div class="item item-type-zoom">
                                <a href="#" class="item-hover">
                                    <div class="item-info">
                                        <div class="headline">
                                        <?php echo $special['item']; ?>
                                            <div class="line"></div>
                                            <div class="dit-line"><?php echo $special['description']; ?></div>
                                        </div>
                                    </div>
                                </a>
                                <div class="item-img">
                                    <img src="<?php echo $special['image']; ?>" alt="sp-menu">
                                </div>
                            </div>
                        <?php } ?>
                            <!-- <div class="item item-type-zoom">
                    ...
                    <div class="tab-menu">
                        ...
                        <?php foreach ($categ as $cat){?>
                            <div class="tab-title-menu">
                                <h2><?= $cat['title_menu']?></h2>
                                <p> <i class="<?= $cat['icon']?>"></i> </p>
                            </div>
                                ...
                                <div class="sf-team">
                                    ...
                                    <div class="text-col">
                                        ...
                                        <ul class="team-social">
                                            <li><a href="<?= $team['social_fb']  ?>"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                                            <li><a href="<?= $team['social_tw']  ?>"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                                            <li><a href="<?= $team['social_link']  ?>"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                            <li><a href="<?= $team['social_wath']  ?>"><i class="fa fa-wathsap" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </div>
            ...
            <div class="row">
                <div class="form-reservations-box">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <form id="contact-form" method="post" class="reservations-box" name="contactform" action="https://technext.github.io/food-funday/mail.php">
...
<!-- Mirrored from technext.github.io/food-funday/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 22 Oct 2022 17:09:05 GMT -->
</html>